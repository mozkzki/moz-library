...
from moz_library.html_parser import HtmlParser
...
class TestHtmlParser:
    ...
    def test_get_rental_books_no_table(self):
        with patch("moz_library.html_parser.HtmlParser._get_books_table") as method:
    ...
    def test_get_books_table(self, type, table_name):
        with patch("moz_library.html_parser.HtmlParser._get_table") as mock:
